          ...
          <div className="collapse navbar-collapse" id="navbar1">
            <ul className="navbar-nav nav nav-fill w-100">
              <li className="nav-item text-white">
                <Link className="nav-link text-white" to="/student_pickproject.html">Home</Link>
              </li>
              <li className="nav-item text-white">
                <div className="btn-group">
                </div></li>
              <li className="nav-item">
                <Link className="nav-link text-white" to="/student_dashboard.html">
                  My Projects
                </Link>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <div className="dropdown show">
                  <a className="btn btn-primary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <svg xmlns="http://www.w3.org/2000/svg" width={22} height={22} fill="currentColor" className="bi bi-person-lines-fill" viewBox="0 0 16 16">
