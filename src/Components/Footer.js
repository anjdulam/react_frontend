...
function Footer() {
  return (
    <>
        ...
        {/* Right */}
        <div className="">
          <a href="#" className="ml-4 mr-3 link-secondary">
            <i className="bi bi-facebook" />
          </a>
          <a href className="me-4 mr-3 link-secondary">
            ...
            <div className="row mt-3">
              ...
              <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                ...
                <h6 className="text-uppercase fw-bold mb-4">
                  <i className="fas fa-gem me-3 text-secondary" />AKOVA
                </h6>
                <p>
        ...
        <div className="text-center p-4" style={{backgroundColor: 'rgba(0, 0, 0, 0.025)'}}>
          © 2022 Copyright:
          <a className="text-reset fw-bold" href="https://mdbootstrap.com/">Akova</a>
        </div>
        {/* Copyright */}
      </footer>
