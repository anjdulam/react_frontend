      ...
      <div className="container ">
        ...
        <div className="row projectcard shadow-lg">
          <div className="col-md-7 text-centre rr">
            ...
            <a href="student_viewproject3.html" className="btn btn-outline-dark active">DETAILS</a>
          </div>
        ...
        <div className="row projectcard shadow-lg">
          <div className="col-md-7 text-centre rr">
            ...
            <a href="student_viewproject.html" className="btn btn-outline-dark active">DETAILS</a>
          </div>
          <div className="col-md-5 imgg d-flex justify-content-end">
            ...
            <img src="" alt="nothing" text-align="right" />
        ...
        <div className="row projectcard shadow-lg">
          <div className="col-md-7 text-centre rr">
            ...
            <p>LibreHealth is the foundation of a worldwide ecosystem of open source Health IT innovation and is a
              ...
              the world. </p>
            <a href="student_viewproject2.html" className="btn btn-outline-dark active">DETAILS</a>
          </div>
          <div className="col-md-5 imgg d-flex justify-content-end">
            <img src="https://media.istockphoto.com/id/1141333760/photo/healthcare-professionals-during-a-meeting-at-the-hospital.jpg?s=612x612&w=0&k=20&c=k7j0mmbdKEuSzrPztNlGIyJuhiePMVICaXAhKL-AR-A=" alt="nothing" text-align="right" />
          </div>
        </div>
